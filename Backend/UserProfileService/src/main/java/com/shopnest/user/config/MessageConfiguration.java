package com.shopnest.user.config;
...
public class MessageConfiguration {
    private String exchangeName="user_exchange_shopnest";
    private String registerQueue="user_queue_shopnest";

    private String updateQueue="update_queue_shopnest";
